...
class VisitorServiceTest {
    ...
    void getAllVisitorsTest() {
        ...
        //then
        PaginatedResponse<VisitorDTO> result = visitorService.getAllVisitors(0, 10, "", "", "");

        assertEquals(2, result.getItems().size());
        assertEquals("juan", result.getItems().get(0).getName());
        assertEquals("joaquin", result.getItems().get(1).getName());
    ...
    void saverOrUpdateVisitorExistingVisitorTest() {
        ...
        VisitorDTO visitorDTOResult = visitorService.saveOrUpdateVisitor(visitorRequest , 1L);
